...
% file : NCO_10MHz_tb.m
%
% Description : The following Matlab testbench excercises the NCO model NCO_10MHz_model.m
...
[sin_out,cos_out] = NCO_10MHz_model(phi_inc_i,phase_mod_i,freq_mod_i);
fid_s = fopen('fsin_o_NCO_10MHz_matlab.txt','w');
for i=1:N
  fprintf(fid_s,'%f\n',sin_out(i));
end
